...
@SpringBootTest
@Transactional
class JpaAttributeConvertersApplicationTests {

  private static final Logger log = LoggerFactory.getLogger(JpaAttributeConvertersApplicationTests.class);
   ...
   * - convertToEntityAttribute is run for Customer and decodes secret.
